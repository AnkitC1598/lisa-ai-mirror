...
>(({ className, children, asChild, ...props }, ref) => (
	<SelectPrimitive.Trigger
		ref={ref}
		className={cn(
			"flex h-10 items-center justify-between rounded-md bg-white text-sm placeholder:text-neutral-500 disabled:cursor-not-allowed disabled:opacity-50 dark:border-neutral-800 dark:bg-neutral-950 dark:placeholder:text-neutral-400",
			asChild
				? ""
				: "w-full border border-neutral-200 px-3 py-2 ring-offset-white focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2 dark:ring-offset-neutral-950 dark:focus:ring-neutral-300 [&>span]:line-clamp-1",
			className
		)}
		{...props}
	>
